...
4. [COMANDO ATOP](https://www.ionos.es/ayuda/infraestructuras-servidores-cloud/monitorizacion/analizar-la-carga-del-sistema-con-atop-linux/)
5. [COMANDO FREE](https://voidnull.es/free-el-comando-para-saber-todo-sobre-nuestra-ram/)
6. [COMANDO DF](https://www.swhosting.com/es/blog/como-revisar-el-espacio-en-disco-en-linux-con-df-y-du#:~:text=El%20Comando%20df,KB%2C%20MB%2C%20GB)
7. [COMANDO DU](https://aprendolinux.com/comando-du-linux-espacio-disco/)
8. [COMANDO IOSTAT](https://administraciondesistemas.com/iostat-linux/)
9. [COMANDO TCPDUMP](https://www.ionos.es/digitalguide/servidores/configuracion/comando-tcpdump-de-linux/)
